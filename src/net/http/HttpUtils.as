package net.http
{
    ...
    public class HttpUtils
    {
        ...
        public static function environ_http_headers( environ:Array,
                                                     find:String = "HTTP_",
                                                     maxHeaders:uint = 0,
                                                     maxHeaderSize:uint = 0,
                                                     gateway:Gateway = null ):Array
        {
            var headers:Array = [];
            ...
            for( i = 0; i < len; i++ )
            {
                ...
                if( (find == "") || (line.indexOf( find ) == 0) )
                {
                    ...
                    if( (maxHeaders != 0) && (count > maxHeaders) && gateway )
                    {
                        gateway.onRequestHeadersTooMany()
                        return null;
                    }
                    
                    if( (maxHeaderSize != 0) && (line.length > maxHeaderSize) && gateway )
                    {
                        gateway.onRequestHeaderSizeTooBig()
                        return null;
                    }

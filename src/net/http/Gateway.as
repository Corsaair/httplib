package net.http
{
     ...
     * 
     * <p>
     * A <code>Gateway</code> is a server access point,
     * its role is to translate a protocol (HTTP for example)
     * to interpret input Request and output Response.
     * </p>
     * 
     */
    public interface Gateway
    {
        ...
        /**
         * Allows to highjack the response to a <code>411 Length Required</code>
         * if the <code>Content-Length</code> header is missing.
         * 
         * <p>
         * 
         * </p>
         */
        function onMissingContentLength():void;
        
        /**
         * 
         */
        function onRequestBodyTooBig():void;
        
        /**
         * 
         */
        function onRequestLineTooBig():void;
        
        /**
         * 
         */
        function onRequestHeadersTooMany():void;
        
        /**
         * 
         */
        function onRequestHeaderSizeTooBig():void;
         ...
         *   </li>
         *   <li>
         *   If the <code>requestMethod</code> is "POST" or "PUT" and the
         ...
         *   </li>
         *   <li>
         *   Finally, we pass the <code>response</code> object to the function
         *   <code>output()</code> which role is to "render" the content
        ...
        /**
         * Write the response content stream to the output (stdout).
         * 
         * <p>
         * Call the functions <code>display()</code> and <code>flush()</code>
